...
cp /usr/obj/usr/src/${TARGET}.${TARGET_ARCH}/release/*.txz ${ARTIFACT_DEST}
cp /usr/obj/usr/src/${TARGET}.${TARGET_ARCH}/release/MANIFEST ${ARTIFACT_DEST}
sudo rm -f /usr/obj/usr/src/${TARGET}.${TARGET_ARCH}/release/*.txz
sudo rm -f /usr/obj/usr/src/${TARGET}.${TARGET_ARCH}/release/MANIFEST
